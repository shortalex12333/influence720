...
| **D3** | **Leadership Book Rollup** | Regional (Macro) | Salesforce CRM | Whole-Department Relationship Union across 5 Producers (**Sabine, Vaughn, Thea, Ellery, Beckett**). Node size = 360 Intimacy Composite Score. Grey hollow nodes = Dark Matter voids (`contact_count == 0`). **ZERO GWP / ZERO DOLLARS.** |
