...
### What D3 IS:
* **A Macro Regional Turf & Relationship Union Map**: Applied strictly to **Salesforce CRM data** aggregated across the firm's 5 real producers (**Sabine, Vaughn, Thea, Ellery, Beckett**) for Sales Leadership, Regional Managers, and Managing Directors.
...
* ❌ **NOT a Single-Producer View**: D3 aggregates all 5 producers (**Sabine, Vaughn, Thea, Ellery, Beckett**) across the regional market.
...
* **Producer Roster (5 Real Producers)**: **Sabine**, **Vaughn**, **Thea**, **Ellery**, **Beckett** (Sourced from `Influence720_MasterOntology.xlsx`).
...
| :--- | :--- | :--- | :--- |
| **Node Color** | Fill Hex Color | Producer Relationship Coverage | **Producer Dominance Hex Color** (Sabine, Vaughn, Thea, Ellery, Beckett) or **Green** (Active Contact in Department) vs. **Grey** (Dark Matter Void) |
...
2. **Macro Graph Renders**: Displays all 168 roles. Nodes reflect the combined relationship coverage of the 5 producers (**Sabine, Vaughn, Thea, Ellery, Beckett**).
